...
Hey, just wanted to give you an update on what I did with the linemen yesterday.

First, we warmed up by working on getting off the ball as quickly as possible.

Then we worked on our footwork for inside zone and outside zone to both the right and left.

Since we were at Ponderosa, we took advantage of the sleds for a few minutes with a focus on generating power from their hips.

That only took about 5–10 minutes.

After that, we went into 2-on-2 pass protection/pass rush, where they got to compete. It was a lot of fun, and we've got some kids who really love to compete.

We finished with 3-on-3 run blocking, where I called inside zone and outside zone.

They are definitly learning more by going live than working against pads. There were quite a few good coaching moments. They seem to understand inside zone better than outside zone right now. I think outside zone is more challenging because they have to get to the edge while also keeping track of the linebacker.

Overall, I thought it was a productive session and the kids made some good progress.

Anyway, just wanted to share. Reminder that I'll be out this week.
